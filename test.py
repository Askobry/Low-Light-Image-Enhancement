...
parser.add_argument('--input_dir', default='../VE-LOL-L/', type=str, help='Input images')
parser.add_argument('--result_dir', default='./results/VE-LOL/', type=str, help='Directory for results')
parser.add_argument('--weights',
                    default='./checkpoints/LLFormer_LOL/models/model_bestSSIM.pth', type=str,
